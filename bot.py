...
“✅ Профиль создан!\n\n”
“👤 Имя: “ + data[“name”] + “\n”
“📅 Возраст: “ + str(data[“age”]) + “ лет\n”
“⚧ Пол: “ + data[“gender”] + “\n”
“📏 Рост: “ + str(data[“height”]) + “ см\n”
“⚖️ Вес: “ + str(weight) + “ кг\n\n”
“Теперь вы можете общаться со мной как с вашим личным врачом!”,
reply_markup=get_main_keyboard()
)
...
if diff > 0:
trend = “\n📈 +” + str(round(diff, 1)) + “ кг с прошлого раза”
elif diff < 0:
trend = “\n📉 “ + str(round(diff, 1)) + “ кг с прошлого раза”
else:
trend = “\n➡️ Вес не изменился”
await update.message.reply_text(
“✅ Вес записан: “ + str(weight) + “ кг” + trend,
reply_markup=get_main_keyboard()
)
return ConversationHandler.END
except ValueError:
...
“Например: Овсянка с бананом и кофе с молоком”
)
return LOG_FOOD
...
“Например: Бег 30 минут или Силовая тренировка 1 час”
)
return LOG_ACTIVITY
...
stats += “👤 “ + user[“name”] + “, “ + str(user[“age”]) + “ лет\n”
stats += “📏 Рост: “ + str(user[“height”]) + “ см\n”
stats += “⚖️ Текущий вес: “ + str(user[“weight”]) + “ кг\n”
if user[“height”] and user[“weight”]:
bmi = user[“weight”] / ((user[“height”] / 100) ** 2)
stats += “📈 ИМТ: “ + str(round(bmi, 1)) + “\n”
if weight_history:
stats += “\n⚖️ История веса:\n”
for entry in weight_history[-7:]:
stats += “  - “ + entry[“date”] + “: “ + str(entry[“weight”]) + “ кг\n”
if recent_food:
...
await update.message.reply_text(
“🧪 Ваш план обследований\n\n” + plan,
reply_markup=get_main_keyboard()
)
except Exception as e:
logger.error(“Error in checkup plan: “ + str(e))
...
score_emoji = “🔴”
msg = “❤️ Оценка вашего здоровья\n\n”
msg += score_emoji + “ Общая оценка: “ + str(score) + “/10\n\n”
...
if bmi_status:
msg += “⚖️ ИМТ: “ + bmi_status + “\n”
if activity_status:
msg += “🏃 Активность: “ + activity_status + “\n”
if nutrition_status:
msg += “🍎 Питание: “ + nutrition_status + “\n”
...
logger.error(“Error in health score: “ + str(e))
...
bmi_status = “Ожирение”
bmi_text = “\n📊 ИМТ: “ + str(round(bmi, 1)) + “ (” + bmi_status + “)”
profile = (
“👤 Ваш профиль\n\n”
“Имя: “ + user[“name”] + “\n”
“Возраст: “ + str(user[“age”]) + “ лет\n”
“Пол: “ + user[“gender”] + “\n”
“Рост: “ + str(user[“height”]) + “ см\n”
“Вес: “ + str(user[“weight”]) + “ кг”
+ bmi_text
)
await update.message.reply_text(profile, reply_markup=get_main_keyboard())
...
user_context = “”
if user:
user_context = “Пациент: “ + user[“name”] + “, “ + str(user[“age”]) + “ лет, “ + user[“gender”] + “, рост “ + str(user[“height”]) + “ см, вес “ + str(user[“weight”]) + “ кг.”
...
logger.error(“Error analyzing photo: “ + str(e))
await update.message.reply_text(
...
await update.message.reply_text(“💬 Задайте любой вопрос о вашем здоровье. Я ваш личный AI-врач!”)
return
...
logger.error(“Error in chat: “ + str(e))
await update.message.reply_text(
